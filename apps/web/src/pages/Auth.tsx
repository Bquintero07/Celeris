    ...
    <div className="min-h-screen bg-background bg-aurora flex items-center justify-center px-4 py-12 relative">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">White-label platform for event logistics</p>
        </div>

        {inviteCode && (
          <div className="mb-4 rounded-lg border border-primary/40 bg-primary/10 px-4 py-3 text-sm text-center">
            You've been invited with code <span className="font-mono font-semibold tracking-widest">{inviteCode}</span>.
            <div className="text-xs text-muted-foreground mt-1">Upon signing in, you'll be automatically added to that organization.</div>
          </div>
        )}
            ...
            <TabsContent value="signup">
              <form onSubmit={signUp} className="space-y-4 mt-4">
                ...
                <p className="text-xs text-muted-foreground text-center">
                  After creating your account you can create an organization or join one with an invite code.
                </p>
              </form>
            </TabsContent>
          </Tabs>
